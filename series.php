...
<?php
    ...
    $sql="SELECT * FROM serije ORDER BY s_id DESC";
...
body  {
  ...
  <h1 class="istaknuto">Istaknute serije</h3>
  ...
  <div class="film" class="<?php if(isset($classname)) echo $classname;?>">
    ...
    <div class="trecaKolona">
      <a class="opsirnije" href="tvShowArticle.php?s_id=<?php echo $row["s_id"]; ?>">Opširnije...</a>
    </div>
